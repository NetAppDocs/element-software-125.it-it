...
. Scaricare OVA o ISO per l'installazione dalla link:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Software Element"^]pagina del sito di supporto NetApp.
+
