...
summary: 'A partire da ONTAP 9.4, è possibile utilizzare SnapMirror per replicare le copie snapshot di un LUN creato su un"origine ONTAP di nuovo in una destinazione Element.' 
---
