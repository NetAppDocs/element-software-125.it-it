...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.175.0.html["Note di rilascio del bundle del firmware di archiviazione 2.175.0"^] _NUOVO_
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.99.2.html["Note di rilascio del bundle del firmware di archiviazione 2.99.2"^]
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.76.html["Note di rilascio del bundle del firmware di archiviazione 2,76"^]
