...
Per ulteriori informazioni, consultare  https://www.netapp.com/pdf.html?item=/media/10607-tr4741.pdf["TR-4741: Replica remota del software NetApp Element"^].
...
Vedi https://www.netapp.com/pdf.html?item=/media/19771-tr-4651.pdf["TR-4651: Architettura e configurazione di NetApp SolidFire SnapMirror"^]
...
Per ulteriori informazioni, vedere link:../storage/element-replication-index.html["Eseguire la replica tra il software NetApp Element e ONTAP (interfaccia a riga di comando di ONTAP)"].
